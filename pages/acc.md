...
Authors have two options for how to fill out the form. Please choose ONE of the following two options.
  ...
  1. You can edit [our Quarto / R Markdown (Rmd) template](../assets/acc_form.Rmd). 
...
To generate a PDF from the Microsoft Word-based form, follow these steps after having filled out the form:
  ...
  - Unprotect the form by unclicking "Review -> Protect Document" (or "Tools -> Protect Document") and unselecting "Protect document for".
  - Remove comments by selecting "Delete All Comments in Document" in the "Comments" section of the "Review" tab.
