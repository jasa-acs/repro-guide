...
The [Reproducibility Review Form](review-form) lists the criteria we would like you to consider in your  review (these criteria have also been provided to the authors in the author guidelines (author-guidelines). It is most helpful if you address the criteria by filling out this review form (you can simply create a document with the section titles as given [here](review-form)) and including the completed form as an attachment with your review. 
